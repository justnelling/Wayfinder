...
#? step 1: set up dependencies that the agent needs 
@dataclass
class GitHubDeps:
    client: httpx.AsyncClient # need http client to make calls to the github api
...
async def get_repo_info(ctx: RunContext[GitHubDeps], github_url: str) -> str:
    ...
    Returns:
        str: Repo information as a formatted string
    '''
